 ...
 *
 * <p>{@link Type#STRING} properties are available only via {@code getProperty}.
 * {@link Type#NUMERIC} properties (uint64) are available via both {@code getProperty}
 * and {@code getLongProperty}. Calling {@code getLongProperty} on a {@code STRING}
 * property throws {@link IllegalArgumentException}.
 *
...
public enum Property {
	...
	/**
	 * The value type of a RocksDB property.
	 *
	 * <ul>
	 *   <li>{@link #STRING} — human-readable text blob; only available via
	 *       {@link RocksDB#getProperty(Property)}.
	 *   <li>{@link #NUMERIC} — uint64 counter or size; available via both
	 *       {@link RocksDB#getProperty(Property)} and
	 *       {@link RocksDB#getLongProperty(Property)}.
	 * </ul>
	 */
	public enum Type {
		STRING,
