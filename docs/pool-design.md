...
- CharPtrPtrPool implements Pool<MemorySegment>: owns Arena.ofShared(), delegates to BlockingPool, zeroes slot on
  release, contiguous block allocation via asSlice
